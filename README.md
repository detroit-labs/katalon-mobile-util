...
Place the [release artifact jar](https://github.com/detroit-labs/katalon-mobile-util/releases/download/1.12.0/katalon-mobile-util-1.12.0.jar) into your Katalon test project's `/Drivers` directory, or follow the Katalon Studio instructions: [How to import external library into your automation project](https://www.katalon.com/resources-center/tutorials/import-java-library/).
